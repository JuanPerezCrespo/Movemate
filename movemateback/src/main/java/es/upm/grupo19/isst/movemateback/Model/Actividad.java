...
public class Actividad {
    ...
    @ManyToOne                          // Relación con la clase Monitor, indicando que una actividad puede estar asociada a más de un monitor.
    @JoinColumn(name = "monitor_id")    // Añade una columna "monitor_id" en la tabla Actividad que referencia a la tabla Monitor.
    private Monitor monitor;
    
    @OneToMany(mappedBy = "actividad")  // Relación con la clase Reserva, indicando que una actividad puede tener varias reservas.
